...
import ArrayObjectOfNodes  from './names3.json';
    ...
    return (
        <aside>
            ...
            {ArrayObjectOfNodes.map(
                nodeInfo => <div key={nodeInfo.id} onDragStart={(e) => onDragStart(e, 'destination', nodeInfo.type, nodeInfo.formFeilds)} style={{display:"flex",justifyContent:"center"}} draggable>
                    {
