...
import ArrayObjectOfNodes  from './bml.json';
    ...
    return (
        <aside>
            ...
            {ArrayObjectOfNodes.map(
                nodeInfo => <div key={nodeInfo.id} onDragStart={(e) => onDragStart(e, 'source', nodeInfo.type, nodeInfo.formFeilds)} style={{display:"flex",justifyContent:"center"}} draggable>
                    {
